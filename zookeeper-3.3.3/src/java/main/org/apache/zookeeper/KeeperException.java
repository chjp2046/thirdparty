...
public abstract class KeeperException extends Exception {
    ...
    public interface CodeDeprecated {
        ...
        // client side defined -116(ZCLOSING), -117(ZNOTHING), -118(ZSESSIONMOVED)
        public static final int NoQuota = -119;

        /** too many new sessions for current role in one second */
        public static final int ServerOverload = -120;
        public static final int TaasLoginFailed = -121;
    }
    ...
    public static enum Code implements CodeDeprecated {
        ...
        NOQUOTA (NoQuota),
        /** Taas Login Failed */
        TAASLOGINFAILED (TaasLoginFailed),
        /** Server Overload */
    ...
    static String getCodeMessage(Code code) {
        switch (code) {
            ...
            case TAASLOGINFAILED:
                return "Taas Login Faild.";
            default:
    ...
    public static class TaasLoginException extends KeeperException {
        public TaasLoginException() {
            super(Code.TAASLOGINFAILED);
        }
    }
}
