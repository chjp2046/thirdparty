...
public class ServerConfig {
    ...
    /** defaults to 100 if not set explicitly */
    protected int maxSessionCreatedPerSecond = 100;
    ...
    public void parse(String[] args) {
        ...
        if (args.length == 5) {
            maxSessionCreatedPerSecond = Integer.parseInt(args[4]);
        }
    }
    ...
    public void readFrom(QuorumPeerConfig config) {
      ...
      maxSessionCreatedPerSecond = config.getMaxSessionCreatedPerSecond();
    }
    ...
    /** maximum sessions can be created per second. */
    public int getMaxSessionCreatedPerSecond() { return maxSessionCreatedPerSecond; }
}
