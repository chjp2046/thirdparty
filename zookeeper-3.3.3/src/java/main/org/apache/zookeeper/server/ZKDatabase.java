...
public class ZKDatabase {
     ...
     * @throws IOException
     */
    public void deserializeSnapshot(InputArchive ia, boolean oldFormat) throws IOException {
        clear();
        SerializeUtils.deserializeSnapshot(getDataTree(),ia,getSessionWithTimeOuts(), oldFormat);
        initialized = true;
    }
