...
public class Observer extends Learner{
    ...
    /**
     * description: this method used to help sync with leader.
     * @param oldFormat the way to read a snapshot from leader.
     * @return true means sync with leader successful.
     * */
    private boolean observeLeaderHelp(boolean oldFormat) throws InterruptedException {
        // register Management object.
        ...
        try {
            ...
            try {
                ...
                syncWithLeader(newLeaderZxid, oldFormat);
                ...
                // exception occured, return false to indicate failure.
                retval = false;
            }
        } finally {
            // unregister Management object.
    ...
    void observeLeader() throws InterruptedException {
        // first observeLeader with new format.
        if (!observeLeaderHelp(false)) {
            // observeLeader with new format.
            observeLeaderHelp(true);
        }
    }
