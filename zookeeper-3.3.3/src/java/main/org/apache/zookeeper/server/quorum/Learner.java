...
public class Learner {
     ...
     * @throws InterruptedException
     */
    protected void syncWithLeader(long newLeaderZxid, boolean oldFormat) throws IOException, InterruptedException{
        ...
        synchronized (zk) {
            if (qp.getType() == Leader.DIFF) {
                ...
                // to be compatible with oldFormat.
                // first try new format to read snapshot, if failure, try old way.
                zk.getZKDatabase().deserializeSnapshot(leaderIs, oldFormat);
