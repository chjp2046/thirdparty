...
public class Follower extends Learner{
    ...
    private boolean followLeaderHelp(boolean oldFormat) throws InterruptedException {
    ...
    void followLeader() throws InterruptedException {
        // first followLeader with new format.
        if (!followLeaderHelp(false)) {
            // followLeader with new format.
            followLeaderHelp(true);
        }
    }
