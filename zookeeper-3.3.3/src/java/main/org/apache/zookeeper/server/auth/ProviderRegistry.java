...
public class ProviderRegistry {
    ...
    public static void initialize() {
        synchronized (ProviderRegistry.class) {
            ...
            if (System.getProperty("zookeeper.disableTaasAuthentication", "no").equals("no")) {
                // add taas authentication provider.
                TaasAuthenticationProvider taasp = new TaasAuthenticationProvider();
                authenticationProviders.put(taasp.getScheme(), taasp);
            }
