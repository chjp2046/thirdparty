        ...
        while (true) {
            try {
                ...
                if (p.getType() == Leader.PING) {
                    ...
                    LOG.warn("Send ping to quorum: " + sock.getRemoteSocketAddress());
                }
            ...
            while (true) {
                ...
                case Leader.PING:
                    ...
                    ByteArrayInputStream bis = new ByteArrayInputStream(qp
                            .getData());
                    DataInputStream dis = new DataInputStream(bis);
                    StringBuilder sb = new StringBuilder("Received pingback from " +
                            sock.getRemoteSocketAddress() + ": ");
                    while (dis.available() > 0) {
                        long sess = dis.readLong();
                        int to = dis.readInt();
                        leader.zk.touch(sess, to);
                        sb.append("0x" + Long.toHexString(sess) + " ");
                    }
                ...
                case Leader.REVALIDATE:
                    ...
                    dos.writeLong(id);
                    LOG.warn("update session timeout 0x" + Long.toHexString(id));
