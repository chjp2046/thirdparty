...
/**
    ...
    public ZooKeeper(String connectString, int sessionTimeout, Watcher watcher)
        throws IOException, KeeperException.TaasLoginException
    {
    ...
    public ZooKeeper(String connectString, int sessionTimeout, Watcher watcher,
        ...
        throws IOException, KeeperException.TaasLoginException
    {
        this(connectString, sessionTimeout, watcher, sessionId, sessionPasswd, null, null);
    }
        ...
        throws IOException, KeeperException.TaasLoginException
    {
        ...
        if (role == null || identity == null || role.equals("") || identity.equals("")) {
            // to be compatible with old server.
            generator = null;
        } else {
            string_p error = new string_p();
            generator = ClientUtility.Login(identity, role, error.cast());
            if (generator == null) {
                LOG.error("Login Failure, error code: " + error.cast());
                throw new KeeperException.TaasLoginException();
            }
        }
        cnxn = new ClientCnxn(connectString, sessionTimeout, this, watchManager, generator);
        cnxn.start();
    }
     ...
     */
    public ZooKeeper(String connectString, int sessionTimeout, Watcher watcher,
            long sessionId, byte[] sessionPasswd, String role, String identity)
        throws IOException, KeeperException.TaasLoginException
    {
        LOG.info("Initiating client connection, connectString=" + connectString
        ...
        cnxn = new ClientCnxn(connectString, sessionTimeout, this, watchManager,
                sessionId, sessionPasswd, generator);
        cnxn.start();
    }
