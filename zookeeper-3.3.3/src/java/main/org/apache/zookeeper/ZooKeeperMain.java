...
public class ZooKeeperMain {
    ...
    private static boolean distableTaas =
        System.getProperty("zookeeper.disableTaasAuthentication", "no").equals("yes");
    ...
    static {
        commandMap.put("connect", "host:port role identity");
            ...
            while (it.hasNext()) {
                ...
                try {
                    if (opt.equals("-server")) {
                        ...
                        options.put("role", it.next());
                    } else if (opt.equals("-identity")) {
                        options.put("identity", it.next());
                    }
    ...
    protected void connectToZK(String newHost, String role, String identity)
        ...
        } catch (KeeperException.TaasLoginException e) {
    ...
    public ZooKeeperMain(String args[]) throws IOException, InterruptedException {
        ...
        connectToZK(cl.getOption("server"), cl.getOption("role"), cl.getOption("identity"));
...
//                Integer.parseInt(cl.getOption("timeout")), new MyWatcher());
        ...
        throws KeeperException, IOException, InterruptedException
    {
        ...
        if (cmd.equals("quit")) {
            ...
            if (args.length >= 4) {
                connectToZK(args[1], args[2], args[3]);
            } else {
                connectToZK(host, null, null);
            }
        }
    ...
    private static List<ACL> parseACLs(String aclString) {
        ...
        for (String a : acls) {
            ...
            try {
                ...
                String id = a.substring(firstColon + 1, lastColon);
                // digest scheme must encrypted the id as his password,
                // other scheme do not need this.
                if (scheme.equals("digest")) {
                    newAcl.setId(new Id(scheme,
                                DigestAuthenticationProvider.generateDigest(id)));
                } else {
