...
public class ConnectResponse implements Record {
  ...
  public void setErrorCode(int m_) {
    errorCode=m_;
  }
  public void serialize(OutputArchive a_, String tag) throws java.io.IOException {
    ...
    a_.writeInt(errorCode,"errorCode");
    a_.endRecord(this,tag);
  }
  public void serialize(OutputArchive a_, String tag, Bool oldVersion) throws java.io.IOException {
    a_.startRecord(this,tag);
    a_.writeInt(protocolVersion,"protocolVersion");
    a_.writeInt(timeOut,"timeOut");
    a_.writeLong(sessionId,"sessionId");
    a_.writeBuffer(passwd,"passwd");
    if (oldVersion.value == false) {
      a_.writeInt(errorCode,"errorCode");
    }
    a_.endRecord(this,tag);
  }
  ...
  public void deserialize(InputArchive a_, String tag) throws java.io.IOException {
    ...
    try {
        errorCode=a_.readInt("errorCode");
    } catch (Exception e) {
  ...
  public int compareTo (Object peer_) throws ClassCastException {
    ...
    if (ret != 0) return ret;
    ret = (errorCode == peer.errorCode)? 0 :((errorCode<peer.errorCode)?-1:1);
    if (ret != 0) return ret;
     return ret;
  }
