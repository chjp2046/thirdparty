...
public class ConnectRequest implements Record {
  ...
  public void setCredential(byte[] m_) {
    credential=m_;
  }
  public void serialize(OutputArchive a_, String tag) throws java.io.IOException {
    ...
    a_.writeBuffer(credential,"credential");
  ...
  public void deserialize(InputArchive a_, String tag) throws java.io.IOException {
    ...
    credential=a_.readBuffer("credential");
    a_.endRecord(tag);
  }

  public void deserialize(InputArchive a_, String tag, Bool oldVersion) throws java.io.IOException {
  ...
  public boolean equals(Object peer_) {
    ...
    if (!ret) return ret;
    ret = org.apache.jute.Utils.bufEquals(credential,peer.credential);
    if (!ret) return ret;
     return ret;
  }
  public int hashCode() {
    ...
    result = 37*result + ret;
    ret = Arrays.toString(credential).hashCode();
    result = 37*result + ret;
    return result;
  }
  public static String signature() {
    return "LConnectRequest(ililBB)";
  }
}
