...
#
prefix       := /data/home/user00/workspace/qrcode
exec_prefix  := ${prefix}
...
#
REQUIRES_PRIVATE   := 
LIBS_PRIVATE       := -lz -lbz2 /data/home/user00/workspace/poppy/build64_release/thirdparty/libpng-1.5.21/libpng15.a
LIBSSTATIC_CONFIG  := -lfreetype -lz -lbz2 /data/home/user00/workspace/poppy/build64_release/thirdparty/libpng-1.5.21/libpng15.a
build_libtool_libs := 
ft_version         := 17.4.11
