 ...
 */
 ...
 PNG_DFN "" 
 PNG_DFN "/* libpng version 1.5.21 - December 22, 2014 */" 
 PNG_DFN "" 
 PNG_DFN "/* Copyright (c) 1998-2011 Glenn Randers-Pehrson */" 
 PNG_DFN "" 
...
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_ok_math_SUPPORTED*/" 
 PNG_DFN "ERROR: ok_math not enabled: requires:, enabled by: FLOATING_POINT FIXED_POINT" 
#endif
...
#   undef PNG_not_enabled /*READ_ALPHA_MODE*/
#endif
...
#   endif /*!command line*/
#   ifdef PNG_on
 PNG_DFN "#define PNG_CHECK_cHRM_SUPPORTED" 
#   endif /* definition */
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_CHECK_cHRM_SUPPORTED*/" 
#endif
PNG_DFN_END_SORT
