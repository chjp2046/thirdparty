...
#include <libmemcached/libmemcachedprotocol-0.0/handler.h>
#include <libmemcached/libmemcached/close_socket.hpp>
#include <libmemcached/example/byteorder.h>
#include "libmemcached/example/storage.h"
#include "libmemcached/example/memcached_light.h"
...
int main(int argc, char **argv)
{
  ...
  int xx;
  for (xx= 0; xx < num_server_sockets; ++xx)
  {
